//---------------------------------------------------------------------------
// Ar2uino - Arduino Reflow Oven Controller - v1.2kg
// More info & FULL description: http://ar2uino.wordpress.com
//
// v1.2kg = Orignal version 1.2, modified by "K"iritoTech, new "G"raphic table temperature line
...
void setup()
{
 ...
 // Set up serial com
 Serial.begin(115200);
 Serial.println(F("Ar2uino Reflow Oven v1.2kg STARTED!"));
 Serial.println("");
...
//----------------------------------------------------------------------------
{
 ...
 byte profile1Temp[] = { 25, 150, 175, 225, 225, 40}; // The temperature for each interval
 ...
 char profile0Name[] = "Lee's";
 byte profile0Temp[] = { 25, 179, 185, 225, 30 };
 byte profile0StepTime[] = { 0, 220, 35, 30,60 };
