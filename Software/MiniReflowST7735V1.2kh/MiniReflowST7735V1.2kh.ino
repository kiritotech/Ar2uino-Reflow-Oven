//---------------------------------------------------------------------------
// Ar2uino - Arduino Reflow Oven Controller - v1.2kh
// More info & FULL description: http://ar2uino.wordpress.com
//
// v1.2kh = Orignal version 1.2, modified by "K"iritoTech, "H"alogen floodlight version
// Modified by KiritoTech 2019-11-18, to work with 1.8" TFT SPI ST7735 and custom PCB and for halogen floodlight
...
void setup()
{
 ...
 // Set up serial com
 Serial.begin(115200);
 Serial.println(F("Ar2uino Reflow Oven v1.2kh STARTED!"));
 Serial.println("");
...
// Date Programmer Action
// 190202 Sfenn ar2uino.wordpress.com original code v1.2
// 2019-11-17 Adapted to work with ST7735 1.8"
//----------------------------------------------------------------------------
{
 int s, i, x, y;
 byte def;
...
//----------------------------------------------------------------------------
{
 ...
 char profile0Name[] = "Lee's";
 byte profile0Temp[] = { 25, 180, 185, 220,, 30 }; // The temperature for each interval
 byte profile0StepTime[] = { 0, 220, 35, 30, 60 }; // The length in secs for interval
